# 🎯 OBJETS DÉTECTABLES PAR YOLOV5

## ⚠️ IMPORTANT À SAVOIR

YOLOv5 détecte **80 types d'objets physiques** du quotidien.  
**IL NE DÉTECTE PAS** : texte, documents, visages individuels, émotions.

---

## ✅ OBJETS QUE YOLOV5 PEUT DÉTECTER
...
3. **Angle** : Objet face à la caméra
4. **Taille** : Objet assez grand dans l'image
...
- Identifier des objets sur un bureau (laptop, phone, cup)
- Surveiller des animaux
- Détecter des bouteilles, fruits, objets du quotidien

**❌ Cas où ça ne marchera PAS :**
- Lire du texte sur un document
- Analyser un examen écrit
...
- ❌ Ce n'est pas un "objet physique" que YOLOv5 connaît
...
- Pour détecter des objets : Utilisez des photos avec personnes, objets, animaux
...
1. Vérifiez que votre image contient un des 80 objets listés ci-dessus
